...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    super.initState();
    _markMessagesAsRead(); //Marks messages as read

    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      if (message.notification != null) {
        print(
            "-Foreground notification received: ${message.notification!.title} - ${message.notification!.body}");//debuging
  ...
  Future<void> _markMessagesAsRead() async {
    ...
    for (var doc in notificationsSnapshot.docs) {
      ...
      print("-Marked notification as read: ${doc.id}");//for debuging 
    }
  }
